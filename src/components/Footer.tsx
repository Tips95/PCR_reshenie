...
import { ADDRESS, PHONE, SOCIAL, WORKING_HOURS } from '@/lib/site'
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <div className="space-y-4">
                <a href={`tel:${PHONE.tel}`} className="flex items-center space-x-3 group">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">{WORKING_HOURS[0].time}, пн-пт</span>
                </div>
              </div>
            </motion.div>
          </div>
